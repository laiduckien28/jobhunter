...
import vn.devops.jobhunter.domain.request.ReqLoginDTO;
import vn.devops.jobhunter.domain.response.ResCreateUserDTO;
import vn.devops.jobhunter.domain.response.ResLoginDTO;
...
public class AuthController {
    ...
    @Value("${devops.jwt.refresh-token-validity-in-seconds}")
